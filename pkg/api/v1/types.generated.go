...
func (x *Container) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq1045[18] = x.ReadOnlyRootFs != false
			...
			if yyr1045 || yy2arr1045 {
				if yyq1045[18] {
					...
					if false {
						...
						r.EncodeBool(bool(x.ReadOnlyRootFs))
					}
				} else {
					r.EncodeBool(false)
				}
				...
				if yyq1045[18] {
					r.EncodeString(codecSelferC_UTF81234, string("readOnlyRootFs"))
					yym1092 := z.EncBinary()
					_ = yym1092
					if false {
					} else {
...
func (x *Container) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj1095 := 0; ; yyj1095++ {
		...
		case "readOnlyRootFs":
			if r.TryDecodeAsNil() {
				x.ReadOnlyRootFs = false
			} else {
				x.ReadOnlyRootFs = bool(r.DecodeBool())
			}
		default:
